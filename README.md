...
---
##### 터미널 경로가 프로젝트 최상위 폴더인지 확인한 후에 진행!!!!!!!!!!!
...
* 어떤 작업을 했는지 상세히 적고 PR을 생성함. 어떤 작업을 했는지 본인이 리뷰 제대로 해주세요
* 다른 팀원들이 코드를 확인하고 승인(Approve)하면, 리더가 **`Merge pull request`** 버튼을 눌러 원본 main 브랜치에 최종적 merge함 인데 1명 이상이 하면 되도록 바꿀 예정입니다
